...
4. **Natural Conversation**: Simply speak. Lingua uses intelligent tags (`[USER_UI]` and `[GUEST_UI]`) generated by the AI to route the translated text and audio to the correct person.
